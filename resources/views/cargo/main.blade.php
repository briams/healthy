    ...
    <div class="navslide navwrap" id="app_content_toolbar">
        <div class="ui menu icon borderless grid" data-color="inverted white">
            <div class="item ui colhidden">
                <button id="new_cargo" class="ui button compact"><i class="icon plus"></i>Nuevo Cargo
                </button>
            </div>
    ...
    <script type="text/javascript">
        ...
        var mainDataSource = new kendo.data.DataSource({
            transport: {
                read: function (options) {
                    ...
                    // };
                    dataSourceBinding(options, "{{ url('cargo/get-main-list') }}")
                }
            },
        ...
        var grid = $("#grid").kendoGrid({
            ...
            columns: [
                ...
                {field: "cargo_nombre", title: 'NOMBRE', width: '80px'},
                {field: "cargo_descripcion", title: 'DESCRIPCION', width: '80px'},
            ...
            dataBound: function (sender, args) {
                ...
                $('.ajxEdit').click(function(e){
                    e.preventDefault();
                    var id = $(this).attr('data-idCargo');
                    window.location.href="{{ url('cargo/editar') }}/"+id;
                });
                ...
                $('.ajxDelete').click(function(e){
                    ...
                    var id = $(this).attr('data-idCargo');
                    $.ajax({
                        url : "{{ action('CargoController@eliminar') }}",
                        data : { id : id },
                        type : 'POST',
                        success : function(response){
                            if (response.status == STATUS_FAIL) {
                                ...
                                toast('success',3000,'Cargo Eliminado');
                                mainDataSource.read();
                            }
                        },
                        statusCode : {
        ...
        $(document).ready(function () {
            ...
            $('#new_cargo').click(function (e) {
                window.location.href = "{{ url('cargo/editar') }}";
            });

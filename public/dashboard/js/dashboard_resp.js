...
function resizeSidebar(op) {
    ...
    if (op == "1") {
        ...
        $(".ui.nodropdown.item.displaynone").addClass("displayblock");
        ...
        $(".ui.nodropdown.item.displaynone").removeClass("displayblock");
...
function resizeSidebar(op) {
    ...
    if (op == "1") {
        ...
        $(".ui.sidebar.left").addClass("very thin icon");
        $(".navslide").addClass("marginlefting");
        $(".mainWrap").addClass("marginlefting");
        $(".sidebar.left span").addClass("displaynone");
        $(".sidebar .accordion").addClass("displaynone");
        $(".ui.dropdown.item.displaynone").addClass("displayblock");
        $(".ui.nodropdown.item.displaynone").addClass("displayblock");
        ...
        $(".ui.sidebar.left").removeClass("very thin icon");
        $(".navslide").removeClass("marginlefting");
        $(".mainWrap").removeClass("marginlefting");
        $(".sidebar.left span").removeClass("displaynone");
        $(".sidebar .accordion").removeClass("displaynone");
        $(".ui.dropdown.item.displaynone").removeClass("displayblock");
        $(".ui.nodropdown.item.displaynone").removeClass("displayblock");
...
function colorize() {
    ...
    if (Cookies.get('headerColor') != undefined) {
        if (z == null) {
            z = $("#app_header").attr("data-color");
        }
        $("#app_header").removeClass(z).addClass(Cookies.get('headerColor'));
        $("#app_header").attr("data-color", Cookies.get('headerColor'));
    }

    $(".colorlist li a").on("click", function(b) {
        var c = $(this).attr("data-addClass");
        if (l == null) {
            l = $("#app_header").attr("data-color");
        }
        console.log(l);
        $("#app_header").removeClass(l).addClass(c);
        l = c;
...
function showConfirm(title, msg, buttonConfirm,callbackOk)
{
  ...
  /*
	$('#app_message_alert .app_message_alert_content').html(msg);
	$('#app_message_alert .app_message_alert_title').html(title);
	$('#app_message_alert .app_message_confirm_button').html(buttonConfirm);
  */
